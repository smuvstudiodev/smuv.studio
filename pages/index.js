  ...
  return (
    <Layout title={"UI/UX and Frontend company."}>
      ...
      <div className='px-5  xl:px-11 max-w-screen-sm md:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-[1409px] mx-auto mt-10 lg:my-20 my-10 lg:mt-20'>
        ...
        <div className="flex flex-col lg:flex-row justify-center text-center gap-y-4 lg:justify-between items-center">
          <div>
            ...
            <a className='flex' target="_blank" rel="noreferrer" href="https://medium.com/@smuvstudio">
              <h2 className="font-bold text-[21px] lg:text-[46px] lg:leading-[47px] text-[#C2C2CC] my-2 flex items-center">
                <span>Find more in our portfolio</span>
                <svg width="91" height="61" className="hidden lg:block" viewBox="0 0 91 61" fill="none" xmlns="http://www.w3.org/2000/svg">
