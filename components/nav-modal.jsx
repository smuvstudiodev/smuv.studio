    ...
    return (
        <div className='nav-modal-container backdrop-blur-[300px]' onClick={e=>closeByBody(e)}>
            <div className='nav-modal moving_card_once' onClick={e=>StopCloseByBody(e)}>
                <div className="flex justify-between pt-6 pb-2 px-7 lg:py-5 lg:px-[40px] bg-[#101012] rounded-tl-xl rounded-tr-xl">
                ...
                <div className=" border-t-2 border-dashed border-[#252529] pt-4  px-7 lg:px-[50px]">
