    ...
    return (
        <div className='nav-modal-container backdrop-blur-[300px]' onClick={e=>closeByBody(e)}>
            <div className='nav-modal moving_card_once' onClick={e=>StopCloseByBody(e)}>
                <div className="flex justify-between py-2 content-center items-center px-4 md:pt-6  md:pb-2  md:px-7 lg:py-5 lg:px-[40px] bg-[#101012] rounded-tl-xl rounded-tr-xl">
                    ...
                    <div className="flex items-center">
                        ...
                        <img src="/images/cancle-icon.svg" className="w-[32px] lg:w-[45px] w-[32px] lg:h-[45px]" alt="close btn"  />
                        </button>
                    </div>
