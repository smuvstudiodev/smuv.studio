...
const Hero = () => {
    ...
    return (
        <div className="relative mt-[100px] lg:mt-[250px] xl:mt-100   flex justify-center justify-items-center content-center md:max-w-screen-lg xl:max-w-screen-2xl mx-auto">
            <object className='hidden top-[-10%] md:top-[-15%] xl:top-[-15%] 2xl:top-[-9%] md:block absolute left-[12%] xl:left-[15%] right-100 item-center self-center md:w-[75%] xl:w-[70%]' type="image/svg+xml" data="/images/Hero_Element.svg"></object>
