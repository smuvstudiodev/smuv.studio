...
const Hero = () => {
    ...
    return (
        <div className="relative mt-[100px] lg:mt-[250px] xl:mt-100  2xl:mt-[200px] flex justify-center justify-items-center content-center md:max-w-screen-lg xl:max-w-screen-2xl mx-auto">
