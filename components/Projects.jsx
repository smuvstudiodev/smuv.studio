        ...
        <div id="works" className=" mt-100">
            <div className='px-5  xl:px-11 max-w-screen-sm md:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-[1409px] mx-auto md:mb-10 md:mt-24 lg:mb-20 lg:mt-40'>
                ...
                <div className="flex flex-col md:flex-row justify-between gap-x-[100px]">
                    <h3 className="font-black text-3xl lg:text-[46px] lg:leading-[47px] text-[#C2C2CC] my-3  lg:w-[55%]">
                        You{"’"}ve Reached the <br className="hidden lg:block" /> Design Zone.
                    </h3>

                    <span className="font-normal lg:font-medium text-[14px] lg:text-[22px] lg:leading-[47px] text-[#737380] my-2 lg:my-0 lg:place-self-start lg:text-right lg:w-[45%]">
                                ...
                                <div className="project " key={project.id}>
                                   <div className="project overflow-hidden coming-soon ">
                                            ...
                                            <div className="project-meta ">
                                                ...
                                                <span className="text-base lg:text-xl text-[#45454D] rounded-full max-w-[158px] font-semibold">Coming Soon</span>
                                            </div>
                                        </div>
                                </div>
                            )
